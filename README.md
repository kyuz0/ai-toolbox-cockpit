...
| Gufo (experimental; Strix Halo only) | Revision-pinned Qwen3.8 Flash Next Q4, Qwen3.8 27B Q4, and DeepSeek V4 Flash 0731 GGUF bundles; baseline, MTP-7, and DSpark profiles; context, concurrent sessions, output limit, model-default/on/off thinking, per-client queue limit, and localhost binding |
